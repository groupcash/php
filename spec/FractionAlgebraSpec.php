...
class FractionAlgebraSpec {
    ...
    function subtract() {
        $this->assert->equals((new Fraction(27, 20))->minus(new Fraction(3, 10)), new Fraction(21, 20));
    }
    ...
    function divide() {
        $this->assert->equals((new Fraction(9, 20))->dividedBy(new Fraction(3, 5)), new Fraction(3, 4));
    }
