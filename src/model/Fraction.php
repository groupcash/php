...
class Fraction implements Finger {
    ...
    public function isGreaterThan(Fraction $fraction) {
        return $this->nominator * $fraction->denominator > $fraction->nominator * $this->denominator;
    }

    public function isLessThan(Fraction $fraction) {
        return $this->nominator * $fraction->denominator < $fraction->nominator * $this->denominator;
    }
